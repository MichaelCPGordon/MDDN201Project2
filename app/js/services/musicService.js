angular.module('services.music', [])
    ...
    .factory('MusicService', function(Spotify, $http, $q){
        ...
        var albumIds = [
            ...
            '0yU7VItpGPmPcvKmwLg0JT', '3tF21h9x3rP8G8C3S7hv3S', '0h9q3anebuWlFwVmdF5ovV', '2wm9XB2x9NaL87uLxALBAP', '37d7HPWhUBzGdl634IHP1d',
            '5a7xlzy9LsS4EwKeOIojMX', '2XjPrtaAqvviEgSHCpzHmM', '1vAEF8F0HoRFGiYOEeJXHW', '6nxDQi0FeEwccEPJeNySoS', '3da6Ihr5l6xjOCDs5sTXIu',
            '6hR1JHA4Vm0wbQrC7zk0pw', '3XshNzZ4orKbbcWy6zZkw3', '2hhNhFoNM6hUuleHFo8J3r', '4jvurVXLanQyP1rPZjbSln', '712VoD72K500yLhhgqCyVe',
            '6S0BIiWtnqU0PtumXMpin0', '0qOxct18eieG99TAQpXave', '1V5vQRMWTNGmqwxY8jMVou', '4Dgxy95K9BWkDUvQPTaYBb', '2n0bnOKXEO2iMEFzAN2UMU',
            ...
            '7lObP1GanG65wToWzufQtq', '22bdIdviOSWmmYEhQxZ7jw', '3qGeRY1wt4rrLIt1YuSwHR', '3PogVmhNucYNfyywZvTd7F', '04r9yvH25PwePggAYZQYq8',
            '5iNF3f0DA9rlVzYYahLFMY', '4uT9DV66lXaM1CMX4HHaSe', '2XJ6x8aCHbMQl71LD6FyNK', '0GTXG38aWGk3x23jKJjFnI', '4ZJNYovzuTG6cQufw6Oh4i',
            ...
            '7qSjHZKOhnMYdqMQMvvlmG', '0e0iTUkry67YVZYQTdKE6c', '5OD4H7aBoUxY83FeYXFrnX', '5HQs8vyZHMHPuwswAbqpbQ', '5lsaAxtO6L0UyxP5SZTYbK',
            '5F3y6k0aX133aBzgKnG5uq', '1Y8JH4HmLxlaej5i360DV6', '1lhoN3qbSRxfSEm6I2t8cK', '2jQAsfSLQUDO0JEljDOppO', '1223HNo18fRbvEKxMgiSa7',
            ...
            Spotify.getAlbumTracks(album.id).then(function (data) {
                for (var i = 0; i < data.items.length; i++){
                    allTracks.push({
                        ...
                        album: album,
                        duration: parseInt((data.items[i].duration_ms / 100).toFixed(0))
                    });
        ...
        generateQueue(artistsOld[2].albums[1].songs, artistsOld[2].albums[1].img, artistsOld[2]);
        generateQueue(artistsOld[5].albums[0].songs, artistsOld[5].albums[0].img, artistsOld[5]);
        generateQueue(artistsOld[1].albums[1].songs, artistsOld[1].albums[1].img, artistsOld[1]);
